...
namespace Flowcode\DashboardBundle\Tests\Controller;
...
class SettingControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $crawler = $client->request('GET', '/admin/amulen/setting/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'setting[name]' => 'Lorem ipsum dolor sit amet',
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/admin/amulen/setting/new');
